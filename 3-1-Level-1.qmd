...
* Use the [`03a - Contributing Area D8`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#contributing-area-d8-tool) tool to calculate the contributing area for the study area watershed. This tool creates the [`contributing_area`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#contributing-area-raster) raster. Rename this DEM `watershed_contributing_area`. 
* Use the [`03a - Contributing Area D8`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#contributing-area-d8-tool) tool to calculate the contributing area for the high resolution DEM. If created, use the [`dem_hydro`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#dem-hydro-raster) raster as input.  
* The `processes` parameter of the [`03a - Contributing Area D8`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#contributing-area-d8-tool) tool can be safely set to approximately 2 less than the number of cores on the computer running the tool. 
...
* Use the [`04 - Stream Network`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#stream-network-tool) tool to create a synthetic stream network from the hydro-modified DEM. The `processes` parameter can be safely set to approximately 2 less than the number of cores on the computer running the tool. 
...
* Use the [`04b - Slope and Sinuosity`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#slope-sinuosity-tool) tool to calculate the slope and sinuosity of the [`stream_networks_points`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#stream-network-points-fc) feature class. 
...
* Use the [`04c - Watershed`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#watershed-tool) tool to create a watershed polygon for each feature in the [`watershed_points`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#watershed-points-fc) feature class. 
...
* Use the [`07 - Detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-dem-tool) tool to create a [`detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-raster)  detrended DEM for the study reach. Set the `buffer_distance` field to a distance wide enough to capture the reach's entire active floodplain.  

### Estimate Initial Channel Extent 
The purpose of this step is to use the detrended DEM to visually extract an initial channel extent polygon. The [`detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-raster) DEM created in the last step can be used to iteratively explore different inundation extents derived from various water surface elevations.  

* Add the [`detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-raster) raster to the map Table of Contents. Name this layer `Channel Extent`. 
...
* Add the [`detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-raster) feature class to the map Table of Contents. Name this layer `Channel Mask`. 
...
* Add the [`detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-raster) feature class to the map Table of Contents. Name this layer `Floodplain Mask`. 
...
* Use the [`11 - XS Layout`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-layout-tool) tool to create a set of regularly spaced cross sections (referred to as transects in this tool). Use the values determined in the previous steps to set this tool's parameters. 
...
* The [`11 - XS Layout`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-layout-tool) tool automatically numbers regular cross sections `Seq` values starting with the value 1 at the downstream-most cross section.  
* Use the [`13a - XS Resequence`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-resequence-tool) tool to set the starting `Seq` value for each reach.  
* For all reaches other than the first reach (downstream-most) in a site, the cross sections must be re-sequenced using the [`13a - XS Resequence`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-resequence-tool) tool. 
...
* Use the [`15a - XS Dimensions, Level 1`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-dimensions-L1-tool) tool to calculate L1 dimensions. 
