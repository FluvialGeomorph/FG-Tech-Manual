...
knitr::include_graphics("docs/figures/toolbox/tool_Hydro_DEM.png")
```

#### `03 - Contributing Area`

```{r echo=FALSE, fig.cap="03 - Contributing Area Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Contributing_Area.png")
```

#### `03a - Contributing Area D8`

```{r echo=FALSE, fig.cap="03a - Contributing Area D8 Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Contributing_Area_D8.png")
```

#### `04 - Stream Network`

```{r echo=FALSE, fig.cap="04 - Stream Network Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Stream_Network.png")
```

#### `04a - Stream Network Points`

```{r echo=FALSE, fig.cap="04a - Stream Network Point Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Stream_Network_Points.png")
```

#### `04b - Slope and Sinuosity`

```{r echo=FALSE, fig.cap="04b - Slope and Sinuosity Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Slope_and_Sinuosity.png")
```

#### `04c - Watershed`

```{r echo=FALSE, fig.cap="04c - Watershed Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Watershed.png")
```

#### `05 - Flowline`

```{r echo=FALSE, fig.cap="05 - Flowline Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Flowline.png")
```

#### `06 - Flowline Points`

```{r echo=FALSE, fig.cap="06 - Flowline Points Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Flowline_Points.png")
```

#### `07 - Detrend DEM`

```{r echo=FALSE, fig.cap="07 - Detrend Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Detrend_DEM.png")
```

#### `08 - Water Surface Extent`

```{r echo=FALSE, fig.cap="08 - Water Surface Extent Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Water_Surface_Extent.png")
```

#### `09 - Channel Slope`

```{r echo=FALSE, fig.cap="09 - Channel Slope Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Channel_Slope.png")
```

#### `10 - Centerline`

```{r echo=FALSE, fig.cap="10 - Centerline Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Centerline.png")
```

#### `11 - XS Layout`

```{r echo=FALSE, fig.cap="11 - XS Layout Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Layout.png")
```

#### `12 - XS Watershed Area`

```{r echo=FALSE, fig.cap="12 - XS Watershed Area Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Watershed_Area.png")
```

#### `13 - XS River Position`

```{r echo=FALSE, fig.cap="13 - XS River Position Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_River_Position.png")
```

#### `13a - XS Resequence`

```{r echo=FALSE, fig.cap="13a - XS Resequence Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Resequence.png")
```

#### `14 - XS Points`

```{r echo=FALSE, fig.cap="14 - XS Points Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Points.png")
```

#### `14b - Bankline Points`

```{r echo=FALSE, fig.cap="14b - Bankline Points Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Bankline_Points.png")
```

#### `14c - XS Assign Loops`

```{r echo=FALSE, fig.cap="14c - XS Assign Loops Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Assign_Loops.png")
```

#### `15a - XS Dimensions, Level 1`

```{r echo=FALSE, fig.cap="15a - XS Dimensions, Level 1 Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Dimensions_L1.png")
```

#### `15b - XS Dimensions, Level 2`

```{r echo=FALSE, fig.cap="15b - XS Dimensions, Level 2 Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Dimensions_L2.png")
```

#### `15c - XS Planform, Level 3`

```{r echo=FALSE, fig.cap="15b - XS Dimensions, Level 3 Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_Dimensions_L3.png")
```

#### `16 - XS RAS Watersurface`

```{r echo=FALSE, fig.cap="16 - XS RAS Watersurface Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_XS_RAS_Watersurface.png")
```
...
knitr::include_graphics("docs/figures/toolbox/tool_Graph-Longitudinal_Profile_Compare.png")
```
...
knitr::include_graphics("docs/figures/toolbox/tool_Map-Reach_Overview.png")
```
...
knitr::include_graphics("docs/figures/toolbox/tool_Report-L1.png")
```
...
```{r echo=FALSE, fig.cap="Map - Reach Overview Tool."}
knitr::include_graphics("docs/figures/toolbox/tool_Report-L2_Estimate_Bankfull.png")
```

#### `Report - L2`

```{r echo=FALSE, fig.cap="Level 2 Report."}
knitr::include_graphics("docs/figures/toolbox/tool_Report-L2.png")
```
...
knitr::include_graphics("docs/figures/toolbox/tool_Report-L3.png")
```
...
knitr::include_graphics("docs/figures/toolbox/Graph-Longitudinal_Profile_Compare.png")
```
...
knitr::include_graphics("docs/figures/toolbox/Report_L1.png")
```

### `Report - L2 Estimate Bankfull`

```{r echo=FALSE, fig.cap="Level 2, Estimate Bankfull Report.", out.width="100%"}
knitr::include_graphics("docs/figures/toolbox/Report_L2_Estimate_Bankfull.png")
```

### `Report - L2`

```{r echo=FALSE, fig.cap="Level 2 Report.", out.width="100%"}
knitr::include_graphics("docs/figures/toolbox/Report_L2.png")
```

### `Report - L3`

```{r echo=FALSE, fig.cap="Level 3 Report.", out.width="100%"}
knitr::include_graphics("docs/figures/toolbox/Report_L3.png")
```
