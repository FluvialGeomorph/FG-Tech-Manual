...
#### `16 - XS RAS Watersurface` {#xs-ras-watersurface}
...
#### `Banklines` {#banklines-symbol}

#### `Contibuting Area` {#contributing-area-symbol}

#### `Cross Section` {#cross-section-symbol}

#### `DEM` {#dem-symbol}

#### `Features` {#features-symbol}

#### `Flowline` {#flowline-symbol}

#### `Flowline Points` {#flowline-points-symbol}

#### `Loop Points` {#loop-points-symbol}

#### `Valleyline` {#valleyline-symbol}
...
* **Level 2 Dimensions** - The [`15b XS Dimensions, Level 1`](#xs-dimensions-l2-tool) tool creates the `*_dims_L2` feature class using these instructions from the user manual for [L2 Initial](https://www.usermanual.fluvialgeomorph.org/level-2-workflow.html#calculate-initial-cross-section-l2-dimension) and [L2 Final](https://www.usermanual.fluvialgeomorph.org/level-2-workflow.html#calculate-final-l2-cross-section-geometry). 
* **Level 3 Dimensions** - The [`15c XS Planform, Level 1`](#xs-planform-l3-tool) tool creates the `*_dims_L3` feature class using these instructions from the [user manual](https://www.usermanual.fluvialgeomorph.org/level-3-workflow.html#calculate-l3-cross-section-geometry). 
