...
The `study_area` polygon feature class is created manually by the analyst using these instructions from the [user manual](https://www.usermanual.fluvialgeomorph.org/level-1-workflow.html#define-study-area). 
