...
{{< badge practical >}} {{< badge resource >}}

This chapter describes the requirements for installing and configuring the FluvialGeomorph toolbox and its required software components. There is more detailed information here than the user manual for requirement and configuration than the user manual.
...
* `ArcGIS Pro` version 3.2+ is recommended. 


###  `ArcMap` it is at it's end of life and is not longer supported.
...
* In `ArcGIS Pro`, navigate to the folder where you just unzipped the archive and you are ready to use this ArcGIS toolbox. 
